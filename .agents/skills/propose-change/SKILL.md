...
1. Read `AGENTS.md`, `wiki/index.md`, relevant wiki units, and recent proposals.
...
8. Identify the smallest useful wiki change that preserves the whole-product picture.
