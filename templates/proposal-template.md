...
two fields to the frontmatter above: approved_by: <approver identity> and
approved_at: YYYY-MM-DD. proposal-lint requires both once a proposal is approved or
implemented. If product-wiki.json declares an "approvers" list, approved_by must match it.
-->
