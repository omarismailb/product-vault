...
Only versions with a published artifact are listed as releases.
The first public release is `2.3.0`, available on the npm registry and tagged `v2.3.0` in git.
Earlier version numbers were internal development milestones.
They were not published to npm or kept as public git tags, so they are grouped under pre-public history rather than presented as releases.

## 2.3.1 - 2026-06-22

Launch-readiness patch for the public npm artifact and docs.

- The npm package now includes the files that the README advertises: `docs/`, `examples/`, `CHANGELOG.md`, contribution and support docs, and the logo asset.
- The CLI help now uses the canonical npm install path and reserves GitHub installs for 40-character commit SHAs.
- The changelog now states that `2.3.0` was the first public release, and keeps earlier version numbers as pre-public development history rather than published artifacts.
- `doctor` now checks version parity, public-release claims, package contents for README-linked files, and npm-first CLI guidance so these issues cannot silently return.
- The import proposal template now says a filled proposal passes the gate after placeholders are replaced.
...
## Pre-2.3.0 development history (pre-public, no published artifacts)

The milestones below were used while the harness was being hardened before the first public release.
They are retained as development history, not as installable releases.

### Internal 2.2.0 milestone - 2026-06-20
...
### Internal 2.1.0 milestone - 2026-06-18
...
### Internal 1.8.1 milestone - 2026-06-18
...
### Internal 1.8.0 milestone - 2026-06-18

Production-readiness hardening during pre-public development.
...
### Internal 1.7.1 milestone - 2026-06-17

Early internal release candidate.
It was not published to npm and is not a public git tag in the launch history.
...
Before those internal milestones, notable development steps were:
