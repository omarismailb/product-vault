...
Agent instructions, hooks, and scripts can change how a repo behaves.
...
- Skills, schemas, scripts, hooks, routines, and templates are managed by Product Wiki.
...
An automatic update could change skills, hooks, or agent rules without the product owner noticing.
